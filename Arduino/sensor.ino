...
// SDA D2
// SCL D1
#define ssid "Redmi_Note"
#define password "quachvanvung"
// Thông tin về MQTT Broker
#define mqtt_server "192.168.43.148" // Thay bằng địa chỉ IP 
#define mqtt_topic_pub "test"   //Giữ nguyên nếu bạn tạo topic tên là demo
#define mqtt_topic_sub "test"
#define mqtt_user "sammy"    //Giữ nguyên nếu bạn tạo user là lophocvui và pass là 123456
